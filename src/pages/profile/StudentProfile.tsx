...
const SUBJECTS: { value: Subject; label: string; color: string }[] = [
  ...
  { value: Subject.URDU, label: 'Urdu', color: 'bg-emerald-500' },
  { value: Subject.ISLAMIYAT, label: 'Islamiyat', color: 'bg-amber-600' },
  { value: Subject.PAKISTAN_STUDIES, label: 'Pak Studies', color: 'bg-green-600' },
  { value: Subject.COMPUTER_SCIENCE, label: 'CS', color: 'bg-blue-500' },
  { value: Subject.GENERAL_KNOWLEDGE, label: 'GK', color: 'bg-cyan-500' },
  { value: Subject.ACCOUNTING, label: 'Accounting', color: 'bg-gray-500' },
  { value: Subject.ECONOMICS, label: 'Economics', color: 'bg-slate-500' },
  { value: Subject.BUSINESS_STUDIES, label: 'Business', color: 'bg-indigo-500' },
  { value: Subject.SOCIOLOGY, label: 'Sociology', color: 'bg-pink-500' },
  { value: Subject.PSYCHOLOGY, label: 'Psychology', color: 'bg-purple-500' },
  { value: Subject.ENVIRONMENTAL_SCIENCE, label: 'Env Science', color: 'bg-lime-600' },
  { value: Subject.GENERAL, label: 'General', color: 'bg-gray-400' },
];
