...
const subjectColors: Record<Subject, string> = {
  ...
  [Subject.URDU]: 'bg-emerald-500 text-white',
  [Subject.ISLAMIYAT]: 'bg-amber-600 text-white',
  [Subject.PAKISTAN_STUDIES]: 'bg-green-600 text-white',
  [Subject.COMPUTER_SCIENCE]: 'bg-blue-500 text-white',
  [Subject.GENERAL_KNOWLEDGE]: 'bg-cyan-500 text-white',
  [Subject.ACCOUNTING]: 'bg-gray-500 text-white',
  [Subject.ECONOMICS]: 'bg-slate-500 text-white',
  [Subject.BUSINESS_STUDIES]: 'bg-indigo-500 text-white',
  [Subject.SOCIOLOGY]: 'bg-pink-500 text-white',
  [Subject.PSYCHOLOGY]: 'bg-purple-500 text-white',
  [Subject.ENVIRONMENTAL_SCIENCE]: 'bg-lime-600 text-white',
...
const subjectLabels: Record<Subject, string> = {
  ...
  [Subject.PAKISTAN_STUDIES]: 'Pak Studies',
  [Subject.COMPUTER_SCIENCE]: 'CS',
  [Subject.GENERAL_KNOWLEDGE]: 'GK',
  ...
  [Subject.ENVIRONMENTAL_SCIENCE]: 'Env Science',
