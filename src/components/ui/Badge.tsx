...
const subjectColors: Record<Subject, string> = {
  ...
  [Subject.GEOGRAPHY]: 'bg-green-600 text-white',
  ...
  [Subject.SOCIAL]: 'bg-pink-500 text-white',
  [Subject.HUMANITIES]: 'bg-indigo-500 text-white',
  [Subject.ARTS]: 'bg-purple-500 text-white',
};
